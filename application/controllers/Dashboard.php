...
public function index(){
    ...
    $basics = $this->home_model->basic_setting();  
    $data['favicon'] = $basics->favicon;
     ...
     if ($this->form_validation->run() === true) {
        ...
        if($check_user){
            ...
            $session_data=$this->session->set_userdata([
                ...
                'logo'        => (!empty($basics->logo)?$basics->logo:null),
                'favicon'     => (!empty($basics->favicon)?$basics->favicon:null),
