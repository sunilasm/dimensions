...
<html lang="en"> 
    ...
    <?php
    if($this->permission->module('add_patient')->access() || $this->permission->module('patient_list')->access() || $this->permission->module('add_document')->access() || $this->permission->module('document_list')->access() ){
    ?>
    ...
    <li class="treeview <?php echo (($this->uri->segment(1) == "setting" || $this->uri->segment(1) == "language" || $this->uri->segment(1) == "autoupdate") ? "active" : null) ?>">
        ...
        <ul class="treeview-menu">
            ...
            <?php
            if($this->permission->method('autoupdate','update')->access() || $this->permission->method('autoupdate','create')->access()){
            ?>
            <li class="<?php echo (($this->uri->segment(2) == "autoupdate")? "active" : null) ?>"><a href="<?php echo base_url("autoupdate") ?>"> <?php echo display('auto_update') ?> </a></li>
            <?php } ?>
        </ul>
    </li>
    <?php } ?>
