            ...
            <div class="panel-body  panel-form"> 
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?= form_open_multipart('website/testimonials/create_language','class="form-inner"') ?>

                            <?= form_hidden('tstml_id', $testimonial->tstml_id);?>
                                ...
                                <div class="col-xs-9">
                                    <div class="form-check">
                                        ...
                                        <label class="radio-inline">
                                            <?php echo form_radio('language', lcfirst($value), (!empty($testimonial->language)?lcfirst($value)==$testimonial->language:lcfirst($value)=='english')).' ' .$value;?>
                                        </label>
                                        <?php }?>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="title"  type="text" class="form-control" id="title" placeholder="<?php echo display('title') ?>" value="<?= $testimonial->title; ?>">
                                </div>
                            </div>
